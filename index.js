...
class FormComponent extends React.Component {
  ...
  formSubmitHandler = event => {
    window.alert('Dados sendo enviados: ' + '\n' +
        this.state.formControls.nome.value + '\n' +
        this.state.formControls.phone.value + '\n' +
        this.state.formControls.cep.value + '\n' +
        this.state.formControls.logradouro.value + '\n' +
        this.state.formControls.numero.value + '\n' +
        this.state.formControls.bairro.value + '\n' +
        this.state.formControls.cidade.value + '\n' +
        this.state.formControls.assunto.value + '\n' +
        this.state.formControls.texto.value)//Possivel verificar com o valid e touched.
